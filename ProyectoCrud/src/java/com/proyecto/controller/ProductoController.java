...
import com.proyecto.facade.ProductoFacade;
...
public class ProductoController implements Serializable {
    ...
    private List<Producto> listaProductos; //getters and setters please!
    private Producto current; //getters and setters please!
    private DataModel items = null;
    @EJB
    private com.proyecto.facade.ProductoFacade ejbFacade; //no van getters and setters
    private PaginationHelper pagination;
    private int selectedItemIndex;

    public List<Producto> consultarTodos() {

        listaProductos = ejbFacade.findAll();
